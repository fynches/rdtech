$(document).ready(function () {
        ...
        oTable = $('#email_index').DataTable({
            ...
            ajax: window.base_url + '/admin/emailtemplates/getData',
            ...
            fnCreatedRow: function (nRow, aData, iDataIndex) {
                ...
                $('td:eq(4)', nRow).html('<a href="'+ window.base_url + '/admin/emailtemplates/' + aData.id + '"><i class="fa fa-eye icon-muted fa-fw icon-space"></i></a>&nbsp &nbsp' +
                        '<a href="'+ window.base_url + '/admin/emailtemplates/' + aData.id + '/edit"><i class="fa icon-muted fa-pencil icon-space"></i></a>');
    ...
    function delete_record(id) {
        if (confirm('Are you sure you want to delete this record?')) {
            $.ajax({
                type: "GET",
                url: '/admin/emailtemplates/delete/' + id, //resource
    ...
    function bulk_actions()          
    {
        ...
        if(bulk_value == 1)
        {
            ...
            if(confirm_flag === true)
            {
                $.ajax({
                type: "GET",
                url: 'delete_multiple_EmailTemplates/'+selected_row_array, 
                dataType: "html",
