...
<div class="portlet light">
    ...
    <div class="form-group">
        <div class="col-md-6">
            ...
            {!! Form::select('image_type', array('Image'), isset($event[0]['getEventMappingMdedia'][0]['image_type'])?$event[0]['getEventMappingMdedia'][0]['image_type']:0, array('class' => 'form-control uploadBanner')) !!}
        </div>
        ...
        <div class=" col-md-6">
            ...
            {!! Form::text('publish_url',$event[0]->publish_url,array('class'=>'form-control')) !!}
            </div>
        </div>                 
    </div> 
        ...
        <div class="row fileupload-buttonbar imageFields" id="img_upload_div">
        	...
        	<table role="presentation" class="table table-striped" id="display_img">
        		<tbody class="files">
        			...
        			if(count($filesa) > 0 && isset($filesa))
        			{
    ...
    <div class="videoFields">
        <div class="form-group">
            <div class="col-md-6"> 
            <?php 
            //pr($event[0]['getEventMappingMdedia']);
            $flagVideo = 0;
            if(isset($event[0]['getEventMappingMdedia'][0]['flag_video'])){
                $flagVideo = $event[0]['getEventMappingMdedia'][0]['flag_video']; 
            }
            ?>
                <input name="flag_video" type="radio" id="url" value="0" <?php if($flagVideo == '0'){echo 'checked';}?> >
                <label for="url">You tube Url</label>
                <br>
                <input name="flag_video" type="radio" value="1" id="file" <?php if($flagVideo == '1'){echo 'checked';}?> >
            ...
            <?php
            	...
            	$youtube_url="";
            	if(isset($event[0]['getEventMappingMdedia'][0]['video']) && $event[0]['getEventMappingMdedia'][0]['flag_video']=="0")
				{
					$youtube_url= $event[0]['getEventMappingMdedia'][0]['video'];
				}
            	//pr($event[0]['getEventMappingMdedia']);
            ?>
            ...
            <div class="col-md-6 video_url" style="<?php if($flagVideo == '1') echo 'display:none';?>">
                ...
                {!! Form::text('video',$youtube_url,array('id'=>'banner_video','class' => 'form-control images')) !!}
                <i>https://www.youtube.com Click on embed and copy like and paste Like:'https://www.youtube.com/embed/xS8IvGxOuwQ' the embade url </i>
            </div>
    ...
    <div class="form-group">
        <div class='col-md-6'>
         ...
         <div class='col-md-6'>
            ...
            {!! Form::text('event_publish_date', date('d-m-Y',strtotime($event[0]->event_publish_date)), array('class' => 'form-control','id'=>'event_publish_date')) !!}
        </div>
    </div>
    ...
    <div class="form-group">
        <div class='col-md-6'>
            ...
            {!! Form::text('event_end_date', date('d-m-Y',strtotime($event[0]->event_end_date)), array('class' => 'form-control','id'=>'event_end_date')) !!}
        </div>
