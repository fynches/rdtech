        ...
        <div class="col-md-9 dashboard-items">
            ...
            <div class="row">
                <div class="col-md-2 col-sm-2 col-xs-4">
                        ...
                        @if($page->live == 1)
                        <a href="/gift-page/{{$page->slug}}"><img src="@if(isset($page->child->recipient_image)){{$page->child->recipient_image}}@endif" alt="Image Here" style="width: 130px;"></a>
                        @else
                        <a href="/gift/{{$page->slug}}"><img src="{{$page->child->recipient_image}}" alt="Image Here" style="width: 100%;"></a>
                        @endif
            ...
            <div class="row" style="margin-top:20px;">
                ...
                <p style="font-size:14px;line-height:14px;color:#34344A;margin-top:10px">Gift Page Status: @if($page->live == 1)Published <a href="" data-id="{{$page->id}}" style="text-decoration: underline;font-size:14px;line-height:14px" id="private_dash">Make Page Private</a>
                @else Unpublished<a href="" data-id="{{$page->id}}" style="text-decoration: underline;" id="live_dash">Make Page Live</a>@endif</p>
                </div>
                
                
                <div class="col-md-3 col-sm-3" style="margin-left:auto;float:right"> 
                    <a href="/redeem-gifts"><img src="https://fynches.codeandsilver.com/public/front/img/redeem.png" alt="Fynches" title="" style="margin: 0 5px;"></a>
                    <a href="/gift-report/{{$page->slug}}"><img src="https://fynches.codeandsilver.com/public/front/img/fund.png" alt="Fynches" title="" style="margin: 0 5px;"></i></a>
                    <a href="/gift/{{$page->slug}}"><img src="https://fynches.codeandsilver.com/public/front/img/edit.png" alt="Fynches" title="" style="margin: 0 5px;"></a>
                    <a class="delete-gift" href=""data-id="{{$page->id}}"><img src="https://fynches.codeandsilver.com/public/front/img/del.png" alt="Fynches" title="" style="margin: 0 5px;"></a>
                </div>
            </div>
            </div>
            @endforeach
