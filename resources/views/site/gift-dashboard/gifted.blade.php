            ...
            @if(isset($purchases))
                ...
                <div class="marg-dash">
                    ...
                    <div class="col-md-3 col-xs-4">
                        <p class="gifted_right" style="font-size:14px;line-height:14px;color:#34344A">Gifted To: {{$gift->child->first_name}}</p> 
                    </div>
                    <div class="col-md-4 col-xs-4">
                        <p style="font-size:14px;line-height:14px;color:#34344A">Gifted ${{$gift->amount}} of ${{$gift->gift->price}} Requested</p>
                    </div>
                    <div class="col-md-3 col-xs-4">
                        @php 
                        ...
                        @endphp
                        <p class="gifted_too_left" style="font-size:14px;line-height:14px;color:#34344A">Gifted On: @isset($date){{$date}}@endisset</p>
                    </div>
                </div>
                </div>
                @endforeach
