<div class="container">
    <div class="form-row" id ="rw">
        <div class="form-group col-md-5">
            ...
            <input required type="text" class="form-control" name="hostFirstName" value="" style="width: 100%;" />
            <div class = 'form-row'>
                <label for="hostLastName" class="required">LAST NAME</label>
                <input required type="text" class="form-control" name="hostLastName" value="" style="width: 100%;" />
            </div>
        </div>
        <div class="form-group col-md-5 col-md-offset-2">
            ...
            <input type="text" class="form-control" name="childName" value="" style="width: 100%;" required />
            <div class="form-row">
                <label for="dob" class="required">DOB</label>
                <input required id="dob" placeholder="Please Select Date" class="date-input form-control" name="dob" value="" type="date" data-date-inline-picker="false" data-date-open-on-focus="true" style="width: 100%;"/>
            </div>
        </div>
    </div>
</div>
