...
<div class="portlet light">
    ...
    <div class="form-group">
        ...
        <div class="col-lg-10">
            <a class="btn btn-default btn-sm btn-dark" href="{{ URL::to('/admin/user/edit_admin/' . $user->id) }}">Change</a>
            <a class="btn btn-default btn-sm btn-dark" href="{{ URL::to('/admin/user/admin_index') }}">Cancel</a>
        </div>
    </div>
    </form>
</div>
